...
int main(int argc, char *argv[]){
    ...
    char sendBuffer[100]; //send buffer holds the message that will be sent to the server
    char receiveBuffer[100]; //receive buffer holds the response from the server
